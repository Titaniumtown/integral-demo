...
const cachedTextEncoder = (typeof TextEncoder !== 'undefined' ? new TextEncoder('utf-8', { ignoreBOM: true, fatal: false }) : { encode: () => { throw Error('TextEncoder not available') } } );
...
export class WebHandle {
    ...
    /**
    *r" Installs a panic hook, then returns.
    */
    constructor() {
    ...
    /**
    *r" Call this once from JavaScript to start your app.
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper2111 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 481, __wbg_adapter_39);
        return addHeapObject(ret);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('292e9d52600901aaa58026d9490d2bb7.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
